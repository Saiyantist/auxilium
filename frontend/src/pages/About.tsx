    ...
    <div className="bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <div className="px-7 py-16">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Mission */}
          <Card className="p-8 bg-gradient-to-br from-purple-500 to-pink-500 text-white hover:shadow-2xl transition-all">
          ...
          {/* Vision */}
          <Card className="p-8 bg-gradient-to-br from-blue-500 to-purple-500 text-white hover:shadow-2xl transition-all">
            <div className="flex items-center gap-4 mb-4">
              <div className="bg-white/20 rounded-full p-3">
      ...
      {/* Core Values */}
      <div className="px-7 bg-white py-20">
        <div>
      ...
      {/* Technology Stack */}
      <div className="px-7 bg-gradient-to-r from-gray-900 to-gray-800 py-20 text-white">
        <div>
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="bg-gray-800/50 border-gray-700 p-6">
                <h3 className="text-2xl font-semibold mb-4 text-purple-400">Frontend</h3>
              ...
              {/* Backend */}
              <Card className="bg-gray-800/50 border-gray-700 p-6">
                <h3 className="text-2xl font-semibold mb-4 text-pink-400">Backend</h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
      ...
      <div className="py-20">
        <div>
          ...
          <Card className="p-8 md:p-12 bg-gradient-to-br from-purple-50 to-pink-50 border-none">
